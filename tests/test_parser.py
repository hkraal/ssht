...
@author: henk
"""
from ssht.plugins import Host, JsonParser, Parser
...
class TestParser:
    ...
    def test_search_hostname(self):
        parser = Parser("/tmp")
        parser._hosts = [Host("host01.example.com"), Host("host02.example.com")]
    ...
    def test_search_ipv4(self):
        parser = Parser("/tmp")
        parser._hosts = [
            Host("host01.example.com", ipv4="192.168.0.1"),
...
class TestJsonParser:
    def test_load_invalid_data(mocker):
        """Ensure invalid JSON exceptions are caught properly"""
